...
public class MovieUtils {
	public static Movie movieDtoToMovie(MovieDTO movieDTO) {
		Movie movie = Movie.builder().title(movieDTO.getTitle()).studio(movieDTO.getStudio())
				.industry(movieDTO.getIndustry()).imdbRating(movieDTO.getImdbRating())
				.releaseYear(movieDTO.getReleaseYear())
				.language(Language.builder().languageName(movieDTO.getLanguageDTO().getLanguageName()).build())
				.financial(Financial.builder().budget(movieDTO.getFinancialDTO().getBudget())
	...
	public static MovieDTO movieToMovieDTO(Movie movie) {
		MovieDTO movieDTO=MovieDTO.builder().title(movie.getTitle()).studio(movie.getStudio())
				.industry(movie.getIndustry()).imdbRating(movie.getImdbRating())
				.releaseYear(movie.getReleaseYear())
				.languageDTO(LanguageDTO.builder().languageName(movie.getLanguage().getLanguageName()).build())
				.financialDTO(FinancialDTO.builder().budget(movie.getFinancial().getBudget())
						.revenue(movie.getFinancial().getRevenue())
						.currency(movie.getFinancial().getCurrency())
						.unit(movie.getFinancial().getUnit())
						.build())
				.build();
